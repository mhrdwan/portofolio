...
function Navbar() {
    ...
    return (
        ...
        <div className={`flex items-center justify-between py-5 mb-4 text-zinc-500 dark:text-zinc-300  ${hide === false && theme === "dark" ? `dark:bg-zinc-900 bg-white  transition-all duration-700 ease-in-out` : ""}  ${hide === false && theme === "dark" && angka <= 100 ? `dark:bg-transparent bg-white  transition-all duration-700 ease-in-out` : ""} ${hide === false && theme === "light" ? `dark:bg-zinc-900 bg-white  transition-all duration-700 ease-in-out` : ""} top-0 sticky z-50`} >
